          ...
          <div className="chart-container" style={{ height: 220 }}>
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={performanceData.slice(-12)} margin={{ top: 4, right: 4, left: 0, bottom: 0 }}>
                ...
                <XAxis dataKey="date" tick={{ fill: '#555872', fontSize: 11 }} axisLine={false} tickLine={false}/>
                <YAxis tick={{ fill: '#555872', fontSize: 11 }} axisLine={false} tickLine={false} tickFormatter={v => '$' + (v/1e6).toFixed(1) + 'M'} width={52}/>
                <Tooltip content={<CustomTooltip />}/>
                <Area type="monotone" dataKey="portfolio" name="Portfolio" stroke="#6366f1" fill="url(#grad1)" strokeWidth={2} dot={false}/>
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 12 }}>
            <PieChart width={140} height={140}>
              <Pie data={allocationData} cx={65} cy={65} innerRadius={42} outerRadius={65} dataKey="value" strokeWidth={2} stroke="#1e2130">
